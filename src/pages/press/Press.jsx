...
const logos = [seattleTimesLogo, guardianLogo, natureLogo, newYorkTimesLogo]
...
export default function Press() {
  return (
    <MainColumn>
      ...
      <Typography variant="subtitle1" style={{ paddingTop: 0, textAlign: 'center' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-evenly', flexWrap: 'wrap' }}>
        {logos.map(logo => (
          <img style={{ margin: 20 }} src={logo} height="30" width="auto" alt="Press logo" />
        ))}
      </div>
      <Divider
      ...
      >
        {articles.map((article, i) => (
          <Grid item key={article.name}>
            ...
            >
              <div style={{ width: 150, maxWidth: '30%', marginLeft: 8, flexShrink: 0 }}>
              ...
              <div style={{ padding: '0 20px' }}>
                ...
                <Typography variant="subtitle2">{article.citation}</Typography>
